# adf-widget-opengateWizards

opengateWizards widget for the [angular-dashboard-framework](https://github.com/sdorra/angular-dashboard-framework).
...
#### Build the adf-widget-opengateWizards
...
```html
<script type="text/javascript" src="path/to/opengateWizards.min.js"></script>
```

Define a dependency for the module:

```javascript
angular.module('sample', ['adf', 'adf.widget.opengateWizards']);
```
